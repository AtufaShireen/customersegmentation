...
class MongoDBmanagement:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.mongo_client = pymongo.MongoClient(self.url,tlsCAFile=certifi.where())
    ...
    def getMongoDBClientObject(self):
        print('''creating a client object for connection''')
    ...
    def closeMongoDBconnection(self,mongo_client):
        print('''Closing connec of client''')
    ...
    def isDatabasePresent(self,db_name):
        print('''Check if database is already present''')
    ...
    def createDatabase(self,db_name):
        print('''Create Database for client''')
